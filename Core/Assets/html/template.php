...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE . "Core/Assets/css/styles.css" ?>">
  ...
  <!--  <script
    ...
    <script src="<?= BASE . "vendor/tinymce/tinymce/tinymce.min.js" ?>"></script>
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.7.7/tinymce.min.js"></script> -->
    <script src="<?= BASE . "vendor/tinymce/tinymce/jquery.tinymce.js" ?>"></script>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= BASE . "accueil"?>">Jean ForteRoche</a>
            </div>
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="<?= BASE . "accueil"?>">Accueil</a></li>
                    <li><a href="<?= BASE . "posts"?>">Mon nouveau livre</a></li>
                    <?php if ( (isset($_SESSION['JFR']['username'])) && ($_SESSION['JFR']['userlevel'] == '1000') ) { ?>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Admin <b class="caret"></b></a>
                            <ul class="dropdown-menu dropdown-menu-inverse">
                                <li><a href="<?= BASE . "admin"?>">Accueil Admin</a></li>
                                <li><a href="<?= BASE . "admin/accueil"?>">Gestion de l' Accueil</a></li>
                                <li><a href="<?= BASE . "admin/users"?>">Gestion des Utilisateurs</a></li>
                                <li><a href="<?= BASE . "admin/posts"?>">Gestion des Posts</a></li>
                                <li><a href="<?= BASE . "admin/posts/alertComments"?>">Gestion des Alertes <?= \Web\Admin\Controller\ControllerAlert::countAlertComments() ?></a></li>
                                <li class="divider"></li>
                                <li><a href="<?= BASE . "logout"?>">Deconnnexion</a></li>
                            </ul>
                        </li>
                    <?php } else { ?>
