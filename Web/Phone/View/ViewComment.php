...
?>
    <div class="row">
        ...
        <div class="col-xs-1  col-xs-offset-<?= $comment->LEVEL - 1; ?> col-md-1 col-md-offset-<?= $comment->LEVEL - 1; ?>">
            <img src="<?= BASE . "Core/Assets/img/arrow-response-64x64.png" ?> " class="img-responsive " alt="reponse">
        </div>
        <?php } ?>
        ...
        <div class="col-xs-<?= $largueur; ?> col-md-<?= $largueur; ?> ">
            <div id="post<?= $comment->COM_ID ?>" class= "<?= $comment->COM_ALERT == "0" ? "panel panel-default" : "panel panel-danger" ?>" >
                ...
                <div class="panel-body">
                    <div class="pull-left">
                        <img src="<? BASE . "Core/Assets/img/avatar-tiny.jpg" ?> "class="media-object img-circle" alt="Utilisateur">
                    </div>
                    <div>
                        <?= $comment->COM_CONTENU; ?>
                    </div>
